...
from .models import Category, CategoryProduct, SelfSaleModule
...
class CategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'module_id', 'products',
                  'order', 'category_image', 'content_type')
            ...
            listOfProducts.append(
                {
                    ...
                    'id_categoryproduct_table': CategoryProduct.objects.filter(product=i, category=instance.id).values_list('id')[0][0],
                    'product_quantity': CategoryProduct.objects.filter(product=i, category=instance.id).values_list('quantity')[0][0]
...
class CreateCategorySerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        attrs['category'] = [name_category, category_image,
                             content_type_id, module_id, product_list]
        return attrs
