    ...
    def __init__(self, **kwargs):
        ...
        self.fields["recipient"] = forms.CharField(
            ...
            widget=forms.TextInput(
                attrs={
                    "class": "form-control autocomplete_username",
                    "autocomplete": "off",
                    "autofocus": "true",
        ...
        self.fields["amount"] = forms.DecimalField(
            ...
            max_digits=9,
            min_value=0,
            max_value=max(self.sender.balance, 0),
        )
        self.fields["justification"] = forms.CharField(
            label="Justification", max_length=254
        )
...
class ExceptionnalMovementForm(forms.Form):
    type_movement = forms.ChoiceField(
        choices=(("debit", "Débit"), ("credit", "Crédit")), label="Type"
    )
...
class RechargingCreateForm(forms.Form):
    type = forms.ChoiceField(
        label="Type",
        choices=(("cash", "Espèces"), ("cheque", "Chèque"), ("lydia", "Lydia")),
    )
    amount = forms.DecimalField(
        label="Montant (€)", decimal_places=2, max_digits=9, min_value=0
    )
...
class SelfLydiaCreateForm(forms.Form):
    def __init__(self, **kwargs):
        ...
        self.fields["tel_number"] = forms.CharField(
            ...
            validators=[
                RegexValidator(
                    "^0[0-9]{9}$", "Le numéro de téléphone doit être du type 0123456789"
                )
            ],
        )
