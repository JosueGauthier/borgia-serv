            ...
            [
                ...
                path(
                    ...
                    include(
                        [
                            path(
                                "exceptionnal_movement/create/",
                                UserExceptionnalMovementCreate.as_view(),
                                name="url_user_exceptionnalmovement_create",
                            ),
                            path(
                                "rechargings/create",
                                RechargingCreate.as_view(),
                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                "create/",
                                TransfertCreate.as_view(),
                                name="url_transfert_create",
                            ),
                            path(
                                "<int:transfert_pk>/",
                                TransfertRetrieve.as_view(),
                ...
                path(
                    ...
                    include(
                        [
                            ...
                            path(
                                "error/currency/",
                                SelfLydiaErrorCurrency.as_view(),
                                name="error_currency",
                            ),
                        ]
                    ),
