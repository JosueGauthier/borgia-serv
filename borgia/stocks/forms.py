...
class AdditionnalDataStockEntryForm(forms.Form):
    isAddingInventory = forms.ChoiceField(
        label="Faire également un inventaire des stocks",
...
class BillEntryCreateForm(forms.ModelForm):
    class Meta:
        model = BillsEntry
        fields = ["billname", "billamount"]

    def clean(self):
        cleaned_data = super().clean()


# class BillsEntryForm(forms.Form):
#     def __init__(self, *args, **kwargs):
#         shop = kwargs.pop("shop")
#         super().__init__(*args, **kwargs)

#     billname = forms.CharField(
#         label="Nom de la facture",
#         required=True,
#         widget=forms.TextInput(
#             attrs={
#                 "class": "form-control centered_input billamount",
#                 "autocomplete": "off",
#                 "autofocus": "true",
