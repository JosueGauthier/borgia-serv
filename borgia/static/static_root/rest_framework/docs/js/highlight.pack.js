!(function (e) {
  ...
  function s(e, t, a, i) {
    ...
    function h() {
      ...
      return (
        L.r > 0 && (B += e.r), "continuous" == L.subLanguageMode && (M[L.sL] = e.top), p(e.language, e.value, !1, !0)
      );
    }
    function b() {
...
hljs.registerLanguage("scss", function (e) {
  ...
  return {
    ...
    c: [
      ...
      { cN: "pseudo", b: "::(after|before|choices|first-letter|first-line|repeat-index|repeat-item|selection|value)" },
      i,
      {
        cN: "attribute",
...
hljs.registerLanguage("haskell", function (e) {
  ...
  return {
    ...
    c: [
      ...
      { cN: "import", b: "\\bimport\\b", e: "$", k: "import|0 qualified as hiding", c: [t].concat(c), i: "\\W\\.|;" },
      {
        cN: "class",
  ...
  var e = "[A-Za-z0-9\\._:-]+",
    ...
    c = {
      ...
      c: [
        ...
        { b: "=", r: 0, c: [{ cN: "value", c: [s], v: [{ b: /"/, e: /"/ }, { b: /'/, e: /'/ }, { b: /[^\s\/>]+/ }] }] },
      ],
    };
  return {
    ...
    c: [
      ...
      i,
      {
        ...
        starts: {
          ...
          k: s,
          c: [
            { cN: "preprocessor", b: t, r: 0, starts: { cN: "markup", e: "\\[noprocess\\]|" + a, rE: !0, c: [n] } },
            o,
            i,
          ].concat(c),
        },
...
hljs.registerLanguage("clojure-repl", function (e) {
  return {
    c: [{ cN: "prompt", b: /^([\w.-]+|\s*#_)=>/, starts: { e: /$/, sL: "clojure", subLanguageMode: "continuous" } }],
  };
});
