    ...
    Gt = {
      ...
      attachElement: function (e) {
        ...
        return e[Ct]
          ? D
          : (n[0] == "^" && ((n = n[_](1)), (r = D)),
            n in Gt[N] ? ((t = Gt[N][n]), t[pt](e[b], r), (e[Ct] = D), e.onAttach && e.onAttach(), D) : a);
      },
      ...
      changeState: function (s) {
        ...
        if (!Gt[H][vt][Gt[r]]) {
          (Gt[H][vt][Gt[r]] = { config: {}, elements: [], values: {} }),
            ...
            c[e][P].content
              ? (T = c[e][P].content)
              : (c[e][P].scalable === a ? p[d]("user-scalable=no") : p[d]("user-scalable=yes"),
      ...
      poll: function () {
        ...
        (e = Gt.getStateId()),
          ...
          e !== Gt[r] &&
            (Gt[Kt]
              ? Gt.changeState(e)
              : ((Gt[N][Mt][g] = Gt[N][Mt][g][U](Gt[r][_](1)[U](new RegExp(Gt.sd, "g"), " "), "")),
                Gt.changeState(e),
      ...
      initAPI: function () {
        ...
        (Gt[q][ot] = 99),
          ...
          r[L](/Firefox/)
            ...
            : r[L](/Trident\/.+rv:([0-9]+)/) && ((e = "ie"), (Gt[q][ot] = RegExp.$1)),
          (Gt[q].browser = e),
          (Gt[q][O] = "other"),
          (t = {
            ...
            Gt[X](s, Gt[e][t][n]),
              ...
              "range" in s &&
                ...
                u == "*"
                  ...
                  : Gt[R](u, "-") != -1 &&
                    ((u = u.split("-")), (a = Et + parseInt(u[0]) + "px) and (max-width: " + parseInt(u[1]) + "px)")),
                (s[Tt] = a)),
              S in s && h in s[S] && typeof s[S][h] != b && (s[S][h] = { vertical: s[S][h], horizontal: s[S][h] }),
              (Gt[e][t][n] = s),
              (r = {}),
                ...
                for (i in n)
                  (t = n[i]),
                    t.charAt(0) == "(" &&
                      ((t = t[_](1, t[f] - 1)),
                      (r = t.split(/:\s+/)),
                      r[f] == 2 && ((s[r[0][U](/^\s+|\s+$/g, "")] = parseInt(r[1])), (o = D)));
                if (!o) return a;
