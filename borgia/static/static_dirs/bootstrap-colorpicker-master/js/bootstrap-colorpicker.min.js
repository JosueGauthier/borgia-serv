...
!(function (a, b) {
  ...
  var b = function (c, d, e, f, g) {
    (this.fallbackValue = e ? (e && "undefined" != typeof e.h ? e : (this.value = { h: 0, s: 0, b: 0, a: 1 })) : null),
    ...
    (b.prototype = {
      ...
      toHex: function (a, b, c, d) {
        ...
        var f =
          ...
          ((1 << 24) + (parseInt(e.r) << 16) + (parseInt(e.g) << 8) + parseInt(e.b)).toString(16).slice(1);
        return f;
      },
      ...
      toString: function (a, c) {
        ...
        switch (a) {
          case "rgb":
            return (
              (d = this.toRGB()), this.rgbaIsTransparent(d) ? "transparent" : "rgb(" + d.r + "," + d.g + "," + d.b + ")"
            );
          case "rgba":
          ...
          case "hsl":
            return (
              (d = this.toHSL()),
              "hsl(" + Math.round(360 * d.h) + "," + Math.round(100 * d.s) + "%," + Math.round(100 * d.l) + "%)"
            );
          case "hsla":
            return (
              (d = this.toHSL()),
      ...
      updateComponent: function (a) {
        ...
        if (((b = "undefined" != typeof a ? this.createColor(a) : this.color), this.component !== !1)) {
          ...
          c.length > 0
            ...
            : this.component.css({ backgroundColor: b.toString(this.format, !0) });
        }
